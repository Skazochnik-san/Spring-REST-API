...
@Sql(value = {"/V1__create-user-before.sql", "/V2__messages-list-before.sql"}, executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
@Sql(value = {"/V3__messages-list-after.sql", "/V4__create-user-after.sql"}, executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
